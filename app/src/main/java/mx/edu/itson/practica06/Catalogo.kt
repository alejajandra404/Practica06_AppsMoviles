    ...
    fun cargarPeliculas() {
        ...
        peliculas.add(
            Pelicula(
                4,
                "Héroe Por Encargo",
                R.drawable.heroexencargo,
                R.drawable.heroeencargo,
        ...
        peliculas.add(
            Pelicula(
                5,
                "Vidas Pasadas",
                R.drawable.vidaspasadas,
                R.drawable.vidaspasada,
    ...
    fun cargarSeries() {
        ...
        series.add(
            Pelicula(
                10,
                "Mi adorable demonio",
                R.drawable.adorabledemonio,
                R.drawable.adorabledemonios,
        ...
        series.add(
            Pelicula(
                ...
                R.drawable.el_monstruo,
                R.drawable.elmonstruovieja,
...
class PeliculaAdapter : BaseAdapter {
    ...
    override fun getView(pe: Int, p1: View?, p2: ViewGroup?): View {
        ...
        image.setOnClickListener {
            ...
            intento.putExtra("id", pelicula.id)
